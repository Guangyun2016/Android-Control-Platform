...
//    private String url = "file:///android_asset/web.html";
    private static final String APP_CACAHE_DIRNAME = "/newscache";
...
//		webSetting.setCacheMode(WebSettings.LOAD_DEFAULT);
        ...
        webView.requestFocusFromTouch();// 设置支持获取手势焦点(区别这里不用getSettings())用户手动输入用户名、密码或其他，则webview必须设置支持获取手势焦点
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onFormResubmission(WebView view, Message dontResend,
                                           Message resend) {
                // TODO Auto-generated method stub (应用程序重新请求网页数据)
                super.onFormResubmission(view, dontResend, resend);
            }

            @Override
            public boolean shouldOverrideUrlLoading(WebView view, String url) {// shouldOverrideUrlLoading在WebView显示网页
                // TODO Auto-generated method stub
                view.loadUrl(url);
                return true;
            }
            ...
            public void onReceivedError(WebView view, int errorCode,
                ...
                // TODO Auto-generated method stub(报告错误信息)
...
//                view.loadUrl(url_error);
            ...
            public void onReceivedHttpAuthRequest(WebView view,
                ...
                // TODO Auto-generated method stub（获取返回信息授权请求）
            ...
            public void onReceivedSslError(WebView view,
                ...
                // TODO Auto-generated method stub重写此方法可以让webview处理https请求
...
//                Log.e(TAG, "onPageStarted");
            ...
            @Override
            public void onPageFinished(WebView view, String url) {// 加载网页完毕
                // TODO Auto-generated method stub
...
//                }
        ...
        // loadUrl();
        webView.loadUrl("http://www.baidu.com");
        //wView.loadUrl("file:///android_asset/index.html");// ----可以用打开本包内asset目录下的index.html文件的方法
